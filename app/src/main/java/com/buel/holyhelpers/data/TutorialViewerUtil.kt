...
import com.buel.holyhelpers.utils.AppUtil.randomMaterialColor
import com.buel.holyhelpers.view.activity.TutorialViewActivity
import com.orhanobut.logger.LoggerHelper
import java.util.*

object TutorialViewerUtil {
    /**
     * 신규가입 튜토리얼
     * @return
     */
    fun getNewUserTutorialModels(context: Context) {
        LoggerHelper.d("getNewUserTutorialModels start")
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
                R.drawable.tuto1,
                "# 튜토리얼을 완료하면 포인트 추가!!",
                "튜토리얼을 완료하면" + CommonData.tutorialPoint + "P 를 지급합니다."))
        tutorialModels.add(getTutorialModel(
                R.drawable.tuto1,
                "#1 단계, 교회설정",
                "확인을 클릭하여 다음으로 넘어갑니다."))
     ...
     * @return
     */
    fun getGroupSelectTutorial(context: Context) {
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
                R.drawable.group1,
                "#1 부서 선택 ",
    ...
    fun getTeamSelectTutorial(context: Context) {
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
                R.drawable.team1,
                "#1 소그룹 선택 ",
     ...
     * @return
     */
    fun getTeamAnalHelperTutorial(context: Context) {
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
                R.drawable.tanal6,
                "#1 소그룹별 통계 ",
    ...
    @JvmStatic
    fun getMemberAccountAdminTutorialModels(context: Context) {
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
     ...
     * @return
     */
    fun getSelectionTutorialModels(context: Context) {
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
     ...
     */
    @JvmStatic
    fun getCreateAccountTutorialModels(context: Context) {
        val tutorialModels: MutableList<TutorialModel> = ArrayList()
        tutorialModels.add(getTutorialModel(
                R.drawable.log_in1,
                "#1 구글로그인",
    ...
    fun setStratTutorialActivity(context: Context, tutorialModels: List<TutorialModel>?) {
        CommonData.tutorialModelList = tutorialModels!!
        val intent = Intent(context, TutorialViewActivity::class.java)
        context.startActivity(intent)
    }

    fun getTutorialModel(
            drawable: Int, title: String?, content: String?): TutorialModel {
        ...
        tutorialModel.color = randomMaterialColor
