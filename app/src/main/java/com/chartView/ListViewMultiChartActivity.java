...
import com.chartView.notimportant.DemoBase;
...
public class ListViewMultiChartActivity extends DemoBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("WrongViewCast") ListView lv = (ListView) findViewById(R.id.listView1);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if(i % 3 == 0) {
                ...
                list.add(new BarChartItem(generateDataBar(i + 1), getApplicationContext(), null));
            } else if(i % 3 == 2) {
